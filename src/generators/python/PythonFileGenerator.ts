...
export class PythonFileGenerator extends PythonGenerator implements AbstractFileGenerator<PythonRenderCompleteModelOptions> {
   ...
   * @param options
   */
  public async generateToFiles(input: Record<string, unknown> | CommonInputModel, outputDirectory: string, options?: PythonRenderCompleteModelOptions): Promise<OutputModel[]> {
