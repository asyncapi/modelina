import { ConstrainedEnumValueModel, MetaModel } from 'models';
...
function fromEnumValueToKotlinType(enumValueModel: ConstrainedEnumValueModel, format: string): string {
