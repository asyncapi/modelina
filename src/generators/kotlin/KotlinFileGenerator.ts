...
export class KotlinFileGenerator extends KotlinGenerator implements AbstractFileGenerator<KotlinRenderCompleteModelOptions> {
  /**
   ...
   */
  public async generateToFiles(input: Record<string, unknown> | InputMetaModel, outputDirectory: string, options: KotlinRenderCompleteModelOptions, ensureFilesWritten = false): Promise<OutputModel[]> {
