...
export class KotlinFileGenerator extends KotlinGenerator implements AbstractFileGenerator<KotlinRenderCompleteModelOptions> {
   ...
   * @param options
   */
  public async generateToFiles(input: Record<string, unknown> | InputMetaModel, outputDirectory: string, options: KotlinRenderCompleteModelOptions): Promise<OutputModel[]> {
