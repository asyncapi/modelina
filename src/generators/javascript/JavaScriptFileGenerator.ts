...
export class JavaScriptFileGenerator extends JavaScriptGenerator implements AbstractFileGenerator<JavaScriptRenderCompleteModelOptions> {
   ...
   */
  public async generateToFiles(input: Record<string, unknown> | InputMetaModel, outputDirectory: string, options?: JavaScriptRenderCompleteModelOptions, skipFileCheck = true): Promise<OutputModel[]> {
