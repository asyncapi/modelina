...
import { CommonModel, CommonInputModel, Draft7Schema, SwaggerV2Schema, AsyncapiV2Schema, OpenapiV3Schema } from '../models';
...
export class JsonSchemaInputProcessor extends AbstractInputProcessor {
  ...
  static reflectSchemaNames(
    schema: Draft7Schema | SwaggerV2Schema | OpenapiV3Schema | boolean,
