...
describe('KotlinConstrainer', () => {
  describe('ObjectModel', () => {
    test('should render the constrained name as type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Object({ constrainedModel: model, options: KotlinGenerator.defaultOptions });
  ...
  describe('Reference', () => {
    test('should render the constrained name as type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Reference({ constrainedModel: model, options: KotlinGenerator.defaultOptions });
      expect(type).toEqual(model.name);
    });
  });
  describe('Any', () => {
    test('should render type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Any({ constrainedModel: model, options: KotlinGenerator.defaultOptions });
  ...
  describe('Float', () => {
    test('should render type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Float({ constrainedModel: model, options: KotlinGenerator.defaultOptions });
  ...
  describe('Integer', () => {
    test('should render type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Integer({ constrainedModel: model, options: KotlinGenerator.defaultOptions });
  ...
  describe('String', () => {
    test('should render type', () => {
      ...
      const type = KotlinDefaultTypeMapping.String({ constrainedModel: model, options: KotlinGenerator.defaultOptions });
  ...
  describe('Boolean', () => {
    test('should render type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Boolean({ constrainedModel: model, options: KotlinGenerator.defaultOptions });
  ...
  describe('Tuple', () => {
    test('should render type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Tuple({constrainedModel: model, options: KotlinGenerator.defaultOptions});
  ...
  describe('Array', () => {
    ...
    test('should render array as a list', () => {
      const arrayModel = new ConstrainedStringModel('test', undefined, 'String');
      const model = new ConstrainedArrayModel('test', undefined, '', arrayModel);
      const options: KotlinOptions = {...KotlinGenerator.defaultOptions, collectionType: 'List'};
      const type = KotlinDefaultTypeMapping.Array({constrainedModel: model, options});
  ...
  describe('Enum', () => {
    test('should render string enum values as String type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Enum({constrainedModel: model, options: KotlinGenerator.defaultOptions});
      expect(type).toEqual('String');
    });
  ...
  describe('Union', () => {
    test('should render type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Union({constrainedModel: model, options: KotlinGenerator.defaultOptions});
      expect(type).toEqual('Any');
    });
  });
  ...
  describe('Dictionary', () => {
    test('should render type', () => {
      ...
      const type = KotlinDefaultTypeMapping.Dictionary({ constrainedModel: model, options: KotlinGenerator.defaultOptions });
