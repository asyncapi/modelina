...
import { DefaultPropertyKeyConstraints, defaultPropertyKeyConstraints, PropertyKeyConstraintOptions } from '../../../../src/generators/kotlin/constrainer/PropertyKeyConstrainer';
describe('PropertyKeyConstrainer', () => {
  ...
  const constrainPropertyName = (propertyName: string) => {
    ...
    return KotlinDefaultConstraints.propertyKey({constrainedObjectModel, objectModel, objectPropertyModel, constrainedObjectPropertyModel });
  };
  afterEach(() => {
  ...
  test('should not contain duplicate properties', () => {
    ...
    const constrainedKey = KotlinDefaultConstraints.propertyKey({constrainedObjectModel, objectModel, objectPropertyModel: objectPropertyModel2, constrainedObjectPropertyModel: constrainedObjectPropertyModel2});
