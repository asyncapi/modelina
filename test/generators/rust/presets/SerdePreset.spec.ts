import { defaultRustRenderCompleteModelOptions, RustGenerator, RustRenderCompleteModelOptions, RUST_SERDE_PRESET } from '../../../../src/generators';

describe('RUST_SERDE_PRESET', () => {
  let generator: RustGenerator;
  beforeEach(() => {
    generator = new RustGenerator({ presets: [RUST_SERDE_PRESET] });
  });
