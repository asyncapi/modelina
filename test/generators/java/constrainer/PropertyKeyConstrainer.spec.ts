...
} from '../../../../src/generators/java/constrainer/PropertyKeyConstrainer';
describe('PropertyKeyConstrainer', () => {
  ...
  const constrainPropertyName = (propertyName: string) => {
    ...
    return JavaDefaultConstraints.propertyKey({
      constrainedObjectModel,
      objectModel,
      objectPropertyModel,
      constrainedObjectPropertyModel
  ...
  test('should not contain duplicate properties', () => {
    ...
    const constrainedKey = JavaDefaultConstraints.propertyKey({
      constrainedObjectModel,
      objectModel,
