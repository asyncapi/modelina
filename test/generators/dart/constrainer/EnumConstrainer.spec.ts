...
import {
  ...
  DefaultEnumKeyConstraints
} from '../../../../src/generators/dart/constrainer/EnumConstrainer';
describe('EnumConstrainer', () => {
  ...
  describe('enum keys', () => {
    test('should never render special chars', () => {
      const constrainedKey = DartDefaultConstraints.enumKey({
        enumModel,
        constrainedEnumModel,
        enumKey: '%',
  ...
  describe('enum values', () => {
    test('should render string values', () => {
      const constrainedValue = DartDefaultConstraints.enumValue({
        enumModel,
        constrainedEnumModel,
