...
} from '../../../../src/generators/dart/constrainer/PropertyKeyConstrainer';
describe('PropertyKeyConstrainer', () => {
  ...
  const constrainPropertyName = (propertyName: string) => {
    ...
    return DartDefaultConstraints.propertyKey({
      constrainedObjectModel,
      objectModel,
      objectPropertyModel,
      constrainedObjectPropertyModel
  ...
  test('should not contain duplicate properties', () => {
    ...
    const constrainedKey = DartDefaultConstraints.propertyKey({
      constrainedObjectModel,
      objectModel,
