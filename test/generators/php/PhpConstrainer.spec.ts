...
describe('PhpConstrainer', () => {
  describe('ObjectModel', () => {
    test('should render the constrained name as type', () => {
      ...
      const type = PhpDefaultTypeMapping.Object({ constrainedModel: model, options: PhpGenerator.defaultOptions });
  ...
  describe('Reference', () => {
    test('should render the constrained name as type', () => {
      ...
      const type = PhpDefaultTypeMapping.Reference({ constrainedModel: model, options: PhpGenerator.defaultOptions });
      expect(type).toEqual(model.name);
    });
  });
  describe('Any', () => {
    test('should render type', () => {
      ...
      const type = PhpDefaultTypeMapping.Any({ constrainedModel: model, options: PhpGenerator.defaultOptions });
      expect(type).toEqual('');
    });
  });
  describe('Float', () => {
    test('should render type', () => {
      ...
      const type = PhpDefaultTypeMapping.Float({ constrainedModel: model, options: PhpGenerator.defaultOptions });
      expect(type).toEqual('');
    });
  });
  describe('Integer', () => {
    test('should render type', () => {
      ...
      const type = PhpDefaultTypeMapping.Integer({ constrainedModel: model, options: PhpGenerator.defaultOptions });
      expect(type).toEqual('');
    });
  });
  describe('String', () => {
    test('should render type', () => {
      ...
      const type = PhpDefaultTypeMapping.String({ constrainedModel: model, options: PhpGenerator.defaultOptions });
      expect(type).toEqual('');
    });
  });
  describe('Boolean', () => {
    test('should render type', () => {
      ...
      const type = PhpDefaultTypeMapping.Boolean({ constrainedModel: model, options: PhpGenerator.defaultOptions });
      expect(type).toEqual('');
    });
  });
  ...
  describe('Tuple', () => {
    test('should render type', () => {
      ...
      const type = PhpDefaultTypeMapping.Tuple({constrainedModel: model, options: PhpGenerator.defaultOptions});
      expect(type).toEqual('');
    });
  ...
  describe('Array', () => {
    test('should render type', () => {
      ...
      const type = PhpDefaultTypeMapping.Array({ constrainedModel: model, options: PhpGenerator.defaultOptions });
      expect(type).toEqual('');
    });
  });
  ...
  describe('Enum', () => {
    test('should render the constrained name as type', () => {
      ...
      const type = PhpDefaultTypeMapping.Enum({ constrainedModel: model, options: PhpGenerator.defaultOptions });
      expect(type).toEqual(model.name);
    });
  });
  ...
  describe('Union', () => {
    test('should render type', () => {
      ...
      const type = PhpDefaultTypeMapping.Union({constrainedModel: model, options: PhpGenerator.defaultOptions});
      expect(type).toEqual('');
    });
  ...
  describe('Dictionary', () => {
    test('should render type', () => {
      ...
      const type = PhpDefaultTypeMapping.Dictionary({ constrainedModel: model, options: PhpGenerator.defaultOptions });
      expect(type).toEqual('');
    });
  });
});
