 ...
 */`);
  ...
  describe('renderProperty()', () => {
    test('Should render property', () => {
      const model = new CommonModel();
      model.properties = {
        testProp: new CommonModel()
      };
      expect(renderer.renderProperty('testProp', model.properties.testProp)).toEqual('testProp?: any;');
    });
    test('Should render property with description', () => {
      const model = new CommonModel();
      const innerModel = new CommonModel();
      innerModel.type = 'string'
      innerModel.originalInput = {
        description: "Description",
      }
      model.properties = {
        testProp: innerModel
      };
      expect(renderer.renderProperty('testProp', model.properties.testProp)).toEqual(
        '/**\n' +
        ' * Description\n' +
        ' */\n' +
        'testProp?: string;');
    });
    test('Should render property with example', () => {
      const model = new CommonModel();
      const innerModel = new CommonModel();
      innerModel.type = 'string'
      innerModel.originalInput = {
    ...
    test('Should render property with multiple examples', () => {
      const model = new CommonModel();
      const innerModel = new CommonModel();
      innerModel.type = 'string'
      innerModel.originalInput = {
    ...
    test('Should render property with description and examples', () => {
      const model = new CommonModel();
      const innerModel = new CommonModel();
      innerModel.type = 'string'
      innerModel.originalInput = {
