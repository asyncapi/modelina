...
describe('PropertyKeyConstrainer', () => {
  ...
  test('should not contain duplicate properties', () => {
    ...
    const constrainedKey = TypeScriptDefaultConstraints.propertyKey({constrainedObjectModel, objectModel, objectPropertyModel: objectPropertyModel2, constrainedObjectPropertyModel: constrainedObjectPropertyModel2});
