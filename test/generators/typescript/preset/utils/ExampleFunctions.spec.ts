...
import { CommonModel, ConstrainedAnyModel, ConstrainedArrayModel, ConstrainedBooleanModel, ConstrainedFloatModel, ConstrainedIntegerModel, ConstrainedReferenceModel, ConstrainedStringModel, ConstrainedTupleModel, ConstrainedTupleValueModel, ConstrainedUnionModel } from '../../../../../src/models';
...
describe('Marshalling preset', () => {
  describe('.renderValueFromModel()', () => {
    test('should render refs correctly', () => {
      ...
      const model = new ConstrainedReferenceModel('SomeOtherModel', undefined, '', refModel);
    ...
    describe('tuples', () => {
      ...
      test('should render multiple array values', () => {
        ...
        const tupleValueModel2 = new ConstrainedTupleValueModel(0, integerModel);
        const model = new ConstrainedTupleModel('test', undefined, '', [tupleValueModel1, tupleValueModel2]);
        const output = renderValueFromModel(model);
