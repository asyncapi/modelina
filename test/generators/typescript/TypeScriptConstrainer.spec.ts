...
describe('TypeScriptConstrainer', () => {
  describe('ObjectModel', () => { 
    test('should render the constrained name as type', () => {
      ...
      const type = TypeScriptDefaultTypeMapping.Object({constrainedModel: model, options: TypeScriptGenerator.defaultOptions});
  ...
  describe('Reference', () => { 
    test('should render the constrained name as type', () => {
      ...
      const type = TypeScriptDefaultTypeMapping.Reference({constrainedModel: model, options: TypeScriptGenerator.defaultOptions});
      expect(type).toEqual(model.name);
    });
  });
  describe('Any', () => { 
    test('should render type', () => {
      ...
      const type = TypeScriptDefaultTypeMapping.Any({constrainedModel: model, options: TypeScriptGenerator.defaultOptions});
  ...
  describe('Float', () => { 
    test('should render type', () => {
      ...
      const type = TypeScriptDefaultTypeMapping.Float({constrainedModel: model, options: TypeScriptGenerator.defaultOptions});
  ...
  describe('String', () => { 
    test('should render type', () => {
      ...
      const type = TypeScriptDefaultTypeMapping.String({constrainedModel: model, options: TypeScriptGenerator.defaultOptions});
  ...
  describe('Boolean', () => { 
    test('should render type', () => {
      ...
      const type = TypeScriptDefaultTypeMapping.Boolean({constrainedModel: model, options: TypeScriptGenerator.defaultOptions});
  ...
  describe('Tuple', () => { 
    test('should render type', () => {
      ...
      const type = TypeScriptDefaultTypeMapping.Tuple({constrainedModel: model, options: TypeScriptGenerator.defaultOptions});
      expect(type).toEqual('[String]');
    });
  ...
  describe('Enum', () => { 
    test('should render the constrained name as type', () => {
      ...
      const type = TypeScriptDefaultTypeMapping.Enum({constrainedModel: model, options: TypeScriptGenerator.defaultOptions});
      expect(type).toEqual(model.name);
    });
  });
  ...
  describe('Union', () => { 
    test('should render type', () => {
      ...
      const type = TypeScriptDefaultTypeMapping.Union({constrainedModel: model, options: TypeScriptGenerator.defaultOptions});
      expect(type).toEqual('String');
    });
