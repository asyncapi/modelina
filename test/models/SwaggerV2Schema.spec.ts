import {SwaggerV2ExternalDocumentation, SwaggerV2Schema, SwaggerV2Xml} from '../../src/models';

describe('SwaggerV2Schema', () => {
  describe('toSchema', () => {
    test('should throw error when trying to convert non-object', () => {
      const expectedError = 'Could not convert input to expected copy of SwaggerV2Schema';
      expect(() => { SwaggerV2Schema.toSchema(1 as any); }).toThrow(expectedError);
    });
    ...
    test('should handle external documentation', () => {
      ...
      const d2 = SwaggerV2Schema.toSchema(d as any) as SwaggerV2Schema;
      expect(typeof d2).toEqual('object');
      expect(d.externalDocs instanceof SwaggerV2ExternalDocumentation).toEqual(true);
    ...
    test('should never return the same instance of properties', () => {
      ...
      expect((d2.properties!['test'] as SwaggerV2Schema).id).not.toEqual('test');
    });
