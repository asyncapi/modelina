import {OpenAPIV3ExternalDocumentation, OpenapiV3Schema, OpenapiV3Xml, OpenapiV3Discriminator} from '../../src/models';

describe('OpenapiV3Schema', () => {
  describe('toSchema', () => {
    test('should throw error when trying to convert non-object', () => {
      const expectedError = 'Could not convert input to expected copy of OpenapiV3Schema';
      expect(() => { OpenapiV3Schema.toSchema(1 as any); }).toThrow(expectedError);
    });
    ...
    test('should handle external documentation', () => {
      ...
      const d2 = OpenapiV3Schema.toSchema(d as any) as OpenapiV3Schema;
      expect(typeof d2).toEqual('object');
      expect(d.externalDocs instanceof OpenAPIV3ExternalDocumentation).toEqual(true);
    ...
    test('should never return the same instance of properties', () => {
      ...
      expect((d2.properties!['test'] as OpenapiV3Schema).id).not.toEqual('test');
    });
