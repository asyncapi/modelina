...
These are the TypeScript specific constraints applied to the MetaModel before reaching the generators.
...
|NO_RESERVED_KEYWORDS|No reserved keywords|TypeScript has a list of reserved keywords ([see the full list here](https://github.com/asyncapi/modelina/blob/4e3604828c92c8951731e0fe569887b1162cbaf1/src/generators/typescript/Constants.ts#L2))|
