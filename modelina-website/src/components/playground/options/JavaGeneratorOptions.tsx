...
type JavaGeneratorState = { }

export const defaultState: JavaGeneratorState = { };

class JavaGeneratorOptions extends React.Component<JavaGeneratorOptionsProps, JavaGeneratorState> {
  ...
  render() {
    return (
      <ul className="flex flex-col">
        <h3 className="text-lg font-medium leading-6 text-gray-900">Java Specific options</h3>
