...
type RustGeneratorState = { }

export const defaultState: RustGeneratorState = { };

class RustGeneratorOptions extends React.Component<RustGeneratorOptionsProps, RustGeneratorState> {
  ...
  render() {
    return (
      <ul className="flex flex-col">
        <h3 className="text-lg font-medium leading-6 text-gray-900">Rust Specific options</h3>
