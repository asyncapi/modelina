...
class GoGeneratorOptions extends React.Component<GoGeneratorOptionsProps, GoGeneratorState> {
  ...
  render() {
    return (
      <ul className="flex flex-col">
        <h3 className="text-lg font-medium leading-6 text-gray-900">Go Specific options</h3>
