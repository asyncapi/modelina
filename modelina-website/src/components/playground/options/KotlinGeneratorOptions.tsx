...
type KotlinGeneratorState = { }

export const defaultState: KotlinGeneratorState = { };

class KotlinGeneratorOptions extends React.Component<KotlinGeneratorOptionsProps, KotlinGeneratorState> {
  ...
  render() {
    return (
      <ul className="flex flex-col">
        <h3 className="text-lg font-medium leading-6 text-gray-900">Kotlin Specific options</h3>
