...
type PythonGeneratorState = { }

export const defaultState: PythonGeneratorState = { };

class PythonGeneratorOptions extends React.Component<PythonGeneratorOptionsProps, PythonGeneratorState> {
  ...
  render() {
    return (
      <ul className="flex flex-col">
        <h3 className="text-lg font-medium leading-6 text-gray-900">Python Specific options</h3>
