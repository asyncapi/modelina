...
type DartGeneratorState = { }

export const defaultState: DartGeneratorState = { };

class DartGeneratorOptions extends React.Component<DartGeneratorOptionsProps, DartGeneratorState> {
  ...
  render() {
    return (
      <ul className="flex flex-col">
        <h3 className="text-lg font-medium leading-6 text-gray-900">Dart Specific options</h3>
