...
export default function InfoModal(props: { text: string; html: any; }){
            ...
            <>  
                ...
                <div className='fixed max-w-[30rem] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-2 rounded-md'>
                    <div className=' px-3 py-2 text-sm font-mono'>
                        <div className=' flex justify-between mb-3'><h2>{props.text}</h2><button onClick={onCloseModal}><p>X</p></button></div>
